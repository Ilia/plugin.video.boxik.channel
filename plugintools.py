...
def add_item( action="" , title="" , plot="" , url="" ,thumbnail="" , folder=True ):
    ...
    listitem = xbmcgui.ListItem( title, iconImage="DefaultAddonIcon.png", thumbnailImage=thumbnail )
    ...
    if url.startswith("plugin://"):
        ...
        xbmcplugin.addDirectoryItem( handle=int(sys.argv[1]), url='', listitem=listitem, isFolder=folder)
    else:
